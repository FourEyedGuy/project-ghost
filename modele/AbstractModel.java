...
public abstract class AbstractModel implements Observable {
	...
	/**
	 * Dire si tous les pions fantômes gentils ont été placés sur plateau par le joueur courant
	 * @return true si tous les pions gentils sont placés sur le plateau
	 */
	public abstract boolean allCurrentPlayerGoodPwnSet();
	
	/**
	 * Dire si tous les pions fantômes méchants ont été placés sur le plateau par le joueur courant
	 * @return true si tous les pions méchants sont placés sur le plateau
	 */
